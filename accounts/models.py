...
class CandidateProfile(models.Model):
    ...
    bio = models.TextField(blank=True, help_text="Longer profile bio.")
    ...
    privacy_photo = models.CharField(max_length=15, choices=PrivacyLevel.choices, default=PrivacyLevel.PUBLIC)
    privacy_headline = models.CharField(max_length=15, choices=PrivacyLevel.choices, default=PrivacyLevel.PUBLIC)
    privacy_location = models.CharField(max_length=15, choices=PrivacyLevel.choices, default=PrivacyLevel.PUBLIC)
    privacy_summary = models.CharField(max_length=15, choices=PrivacyLevel.choices, default=PrivacyLevel.PUBLIC)
    privacy_bio = models.CharField(max_length=15, choices=PrivacyLevel.choices, default=PrivacyLevel.PUBLIC)
    privacy_education = models.CharField(max_length=15, choices=PrivacyLevel.choices, default=PrivacyLevel.PUBLIC)
    privacy_experience = models.CharField(max_length=15, choices=PrivacyLevel.choices, default=PrivacyLevel.PUBLIC)
    privacy_skills = models.CharField(max_length=15, choices=PrivacyLevel.choices, default=PrivacyLevel.PUBLIC)
...
class Experience(models.Model):
    profile = models.ForeignKey(CandidateProfile, related_name='experiences', on_delete=models.CASCADE)
